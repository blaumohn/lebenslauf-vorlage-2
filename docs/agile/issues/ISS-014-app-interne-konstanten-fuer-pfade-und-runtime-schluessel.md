...
## Ziel
- App-weite technische Konstanten zentralisieren (PHP-intern, ohne Config-Lib-Integration).
- Pfad- und Schluesseldefinitionen an einer Stelle pflegen und in Runtime/CLI wiederverwenden.
...
## Scope
- Eine zentrale App-Komponente fuer technische Konstanten definieren (z. B. `AppRuntimePaths`).
...
## Akzeptanzkriterien
- Es existiert eine zentrale Stelle fuer app-interne technische Konstanten.
